...
2. Run `script/context <task-id>` to get the task description and review any comments left by other agents.
...
- If you need to document notes, thoughts, or explain your approach to the Tester/Boss, use the comment script: `script/comment <task-id> "<your comment>"`