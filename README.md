...
```text
                           +--------------------------+
                           |   Owner / Operator (1)   | <======== [ Fail 4+ (Halt) ]
                           +--------------------------+              |
                                      |                              |
                                      v                              |
+-----------------------------------------------------------------+  |
|  Autonomous Agent Triad                                         |  |
|                                                                 |  |
|     +-------------------+                                       |  |
|  +->|  Developer (ID 2) | <===========================+         |  |
|  |  +-------------------+                             |         |  |
...
|  |       v         v                                  |         |  |
|  |   [ Done ]  [ Escalation Rules ]                   |         |  |
|  |                 |                                  |         |  |
|  |                 +-- Strikes 1 & 2: Retry Dev ------+         |  |
|  |                 |                                  |         |  |
|  |                 +-- Strike 3: Escalated to --------+         |  |
|  |                 |   Lead Engineer (ID 5)           |         |  |
|  |                 |   (Boss invokes LE to resolve    |         |  |
|  |                 |    triad deadlock & guide Dev)   |         |  |
|  |                 |                                  |         |  |
|  |                 +-- Strike 4+: Escalate to Owner ------------+  |
|  |                                                                 |
+-----------------------------------------------------------------+
```
